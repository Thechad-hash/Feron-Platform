...
var _allowInsecure, _gzip, _headers, _method, _timeout, _url, _body, _bodyType, _creds, _preflight, _process, _retry, _signal, _throttle, _FetchRequest_instances, send_fn;
...
var AbstractProvider = class {
  ...
  async getFeeData() {
    const { block, gasPrice } = await resolveProperties({
      ...
      gasPrice: (async () => {
        try {
          const gasPrice2 = await __privateMethod(this, _AbstractProvider_instances, perform_fn).call(this, { method: "getGasPrice" });
...
var _options3, _nextId, _payloads, _drainTimer, _notReady, _network2, _JsonRpcApiProvider_instances, scheduleDrain_fn;
